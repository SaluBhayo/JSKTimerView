...
- (void)viewDidLoad
{
    ...
    // Start timer
//    [self.timerView startTimerWithEndDate:[NSDate dateWithTimeIntervalSinceNow:600]];
    [self.timerView setProgressColor:[UIColor yellowColor] withStrokeColor:[UIColor grayColor]];
    [self.timerView startTimerWithStartDate:[NSDate dateWithTimeIntervalSinceNow:-30] andEndDate:[NSDate dateWithTimeIntervalSinceNow:60]];
